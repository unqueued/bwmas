...
public class UnitManagerAgentInitFIPAReqResM extends AchieveREInitiator{

  UnitManagerAgent agent = null;
  DataStore ds = null;
  ACLMessage msg = null;

  public UnitManagerAgentInitFIPAReqResM(UnitManagerAgent a, ACLMessage msg){
    super(a, msg);
    this.msg = msg;
    this.agent = a;
    ds = agent.getDS();
