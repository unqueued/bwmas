...
public class BattleManagerAgentRespFIPAReqMapM extends AchieveREResponder {
	BattleManagerAgent agent=null;	
  MessageTemplate mt = null;

  public BattleManagerAgentRespFIPAReqMapM(BattleManagerAgent a, MessageTemplate mt) {
    super(a, mt);
    agent=a;
    this.mt=mt;
  ...
  protected ACLMessage handleRequest(ACLMessage request) throws NotUnderstoodException, RefuseException {
    ...
    if(request != null && request.getConversationId() != null){
      if( request.getConversationId().equals(ConverId.BattM.LocationEnemySeen.getConId()) ){
