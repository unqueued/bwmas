...
public class BattleManagerAgent extends Agent{
  ...
  AID unit_manager = null;
    ...
    //  GameObject
    //  GameObjectUpdate
    root_behaviour.addSubBehaviour(new BattleManagerAgentRespInfCmd(this,commander_inform_mt));

    root_behaviour.addSubBehaviour(new BattleManagerAgentRespFIPAReqUnitM(this,unitm_fipa_req_mt));
    root_behaviour.addSubBehaviour(new BattleManagerAgentRespFIPAReqMapM(this,mapm_fipa_req_mt));
    root_behaviour.addSubBehaviour(new BattleManagerAgentRespFIPAReqCmd(this,cmd_fipa_req_mt));
