...
public class StructureManagerAgentInitFIPARequest {
	Agent agent=null;

  public StructureManagerAgentInitFIPARequest(Agent a, String[] receivers, String converID, String msg_content) {
    agent=a;
