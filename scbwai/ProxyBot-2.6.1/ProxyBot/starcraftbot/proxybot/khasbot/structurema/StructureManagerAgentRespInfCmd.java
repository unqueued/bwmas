...
public class StructureManagerAgentRespInfCmd extends CyclicBehaviour{
	StructureManagerAgent agent=null;	
  MessageTemplate mt = null;

  public StructureManagerAgentRespInfCmd(StructureManagerAgent a, MessageTemplate mt) {
    super(a);
    agent=a;
    this.mt=mt;
  }
    ...
    if (msg != null) {
      if(msg.getConversationId().equals(ConverId.Game.InitGameObj.getConId())){
        try {
          ...
          Logger.getLogger(StructureManagerAgentRespInfCmd.class.getName()).log(Level.SEVERE, null, ex);
        }
