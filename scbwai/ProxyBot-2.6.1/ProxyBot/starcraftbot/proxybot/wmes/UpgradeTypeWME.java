...
public class UpgradeTypeWME extends WME {
	...
	/**
	 * number of times the upgrade can be researched. usually 1, 3 for weapon
	 * upgrades
	 */
	private int repeats;
	...
	public UpgradeTypeWME(int id, String name, int whatResearchesID,
			int repeats, int mineralsBase, int mineralsFactor, int gasBase,
			int gasFactor) {
		this.id = id;
		this.name = name;
	...
	/**
	 * Number of times the upgrade can be researched, usually 1, 3 or attack and
	 * armor upgrades.
	 */
	...
	public String toString() {
		return "id:" + id + " name:" + name + " whatResearches:"
				+ whatResearchesID + " repeats:" + repeats + " minsBase:"
				+ mineralsBase + " minsFactor:" + mineralsFactor + " gasBase:"
				+ gasBase + " gasFactor:" + gasFactor;
	}
	...
	public enum UpgradeType {
		Terran_Infantry_Armor, Terran_Vehicle_Plating, Terran_Ship_Plating, Zerg_Carapace, Zerg_Flyer_Carapace, Protoss_Armor, Protoss_Plating, Terran_Infantry_Weapons, Terran_Vehicle_Weapons, Terran_Ship_Weapons, Zerg_Melee_Attacks, Zerg_Missile_Attacks, Zerg_Flyer_Attacks, Protoss_Ground_Weapons, Protoss_Air_Weapons, Protoss_Plasma_Shields, U_238_Shells, Ion_Thrusters, undefined0, Titan_Reactor, Ocular_Implants, Moebius_Reactor, Apollo_Reactor, Colossus_Reactor, Ventral_Sacs, Antennae, Pneumatized_Carapace, Metabolic_Boost, Adrenal_Glands, Muscular_Augments, Grooved_Spines, Gamete_Meiosis, Metasynaptic_Node, Singularity_Charge, Leg_Enhancements, Scarab_Damage, Reaver_Capacity, Gravitic_Drive, Sensor_Array, Gravitic_Boosters, Khaydarin_Amulet, Apial_Sensors, Gravitic_Thrusters, Carrier_Capacity, Khaydarin_Core, undefined1, undefined2, Argus_Jewel, undefined3, Argus_Talisman, undefined4, Caduceus_Reactor, Chitinous_Plating, Anabolic_Synthesis, Charon_Booster, undefined5, undefined6, undefined7, undefined8, undefined9, undefined10, None, Unknown
	};
	...
	public static ArrayList<UpgradeTypeWME> getUpgradeTypes() {
		...
		types.add(new UpgradeTypeWME(0, "Terran_Infantry_Armor", 122, 3, 100,
				75, 75, 75));
		types.add(new UpgradeTypeWME(1, "Terran_Vehicle_Plating", 123, 3, 100,
				75, 75, 75));
		types.add(new UpgradeTypeWME(2, "Terran_Ship_Plating", 123, 3, 150, 75,
				75, 75));
		types.add(new UpgradeTypeWME(3, "Zerg_Carapace", 139, 3, 150, 75, 75,
				75));
		types.add(new UpgradeTypeWME(4, "Zerg_Flyer_Carapace", 141, 3, 150, 75,
				75, 75));
		types.add(new UpgradeTypeWME(5, "Protoss_Armor", 166, 3, 100, 75, 75,
				75));
		types.add(new UpgradeTypeWME(6, "Protoss_Plating", 164, 3, 150, 75, 75,
				75));
		types.add(new UpgradeTypeWME(7, "Terran_Infantry_Weapons", 122, 3, 100,
				75, 75, 75));
		types.add(new UpgradeTypeWME(8, "Terran_Vehicle_Weapons", 123, 3, 100,
				75, 75, 75));
		types.add(new UpgradeTypeWME(9, "Terran_Ship_Weapons", 123, 3, 100, 50,
				50, 50));
		types.add(new UpgradeTypeWME(10, "Zerg_Melee_Attacks", 139, 3, 100, 50,
				50, 50));
		types.add(new UpgradeTypeWME(11, "Zerg_Missile_Attacks", 139, 3, 100,
				50, 50, 50));
		types.add(new UpgradeTypeWME(12, "Zerg_Flyer_Attacks", 141, 3, 100, 75,
				75, 75));
		types.add(new UpgradeTypeWME(13, "Protoss_Ground_Weapons", 166, 3, 100,
				50, 50, 50));
		types.add(new UpgradeTypeWME(14, "Protoss_Air_Weapons", 164, 3, 100,
				75, 75, 75));
		types.add(new UpgradeTypeWME(15, "Protoss_Plasma_Shields", 166, 3, 200,
				100, 100, 100));
		...
		types.add(new UpgradeTypeWME(20, "Ocular_Implants", 117, 1, 100, 0, 0,
				0));
		types.add(new UpgradeTypeWME(21, "Moebius_Reactor", 117, 1, 150, 0, 0,
				0));
		types.add(new UpgradeTypeWME(22, "Apollo_Reactor", 115, 1, 200, 0, 0, 0));
		types.add(new UpgradeTypeWME(23, "Colossus_Reactor", 118, 1, 150, 0, 0,
				0));
		types.add(new UpgradeTypeWME(24, "Ventral_Sacs", 132, 1, 200, 0, 0, 0));
		types.add(new UpgradeTypeWME(25, "Antennae", 132, 1, 150, 0, 0, 0));
		types.add(new UpgradeTypeWME(26, "Pneumatized_Carapace", 132, 1, 150,
				0, 0, 0));
		types.add(new UpgradeTypeWME(27, "Metabolic_Boost", 142, 1, 100, 0, 0,
				0));
		types.add(new UpgradeTypeWME(28, "Adrenal_Glands", 142, 1, 200, 0, 0, 0));
		types.add(new UpgradeTypeWME(29, "Muscular_Augments", 135, 1, 150, 0,
				0, 0));
		...
		types.add(new UpgradeTypeWME(32, "Metasynaptic_Node", 136, 1, 150, 0,
				0, 0));
		types.add(new UpgradeTypeWME(33, "Singularity_Charge", 164, 1, 150, 0,
				0, 0));
		types.add(new UpgradeTypeWME(34, "Leg_Enhancements", 163, 1, 150, 0, 0,
				0));
		types.add(new UpgradeTypeWME(35, "Scarab_Damage", 171, 1, 200, 0, 0, 0));
		types.add(new UpgradeTypeWME(36, "Reaver_Capacity", 171, 1, 200, 0, 0,
				0));
		...
		types.add(new UpgradeTypeWME(39, "Gravitic_Boosters", 159, 1, 150, 0,
				0, 0));
		types.add(new UpgradeTypeWME(40, "Khaydarin_Amulet", 165, 1, 150, 0, 0,
				0));
		types.add(new UpgradeTypeWME(41, "Apial_Sensors", 165, 1, 100, 0, 0, 0));
		types.add(new UpgradeTypeWME(42, "Gravitic_Thrusters", 169, 1, 200, 0,
				0, 0));
		types.add(new UpgradeTypeWME(43, "Carrier_Capacity", 169, 1, 100, 0, 0,
				0));
		...
		types.add(new UpgradeTypeWME(51, "Caduceus_Reactor", 112, 1, 150, 0, 0,
				0));
		types.add(new UpgradeTypeWME(52, "Chitinous_Plating", 140, 1, 150, 0,
				0, 0));
		types.add(new UpgradeTypeWME(53, "Anabolic_Synthesis", 140, 1, 200, 0,
				0, 0));
