...
public class CommandQueue {
	 ...
	 * 
	 * @param command
	 *            - the command to execture, see the Orders enumeration
	 * @param unitID
	 *            - the unit to control
	 * @param arg0
	 ...
	 */
	private void doCommand(StarCraftCommand command, int unitID, int arg0,
			int arg1, int arg2) {
		synchronized (commandQueue) {
			Command order = new Command(command, unitID, arg0, arg1, arg2);
	...
	public void useTech(int unitID, int techTypeID, int targetID) {
		doCommand(StarCraftCommand.useTechTarget, unitID, techTypeID, targetID,
				0);
	}
	...
	public void setScreenPosition(int x, int y) {
		doCommand(StarCraftCommand.screenPosition, x, y, 0, 0);
	}

	/**
	 * Draws a line on the map. 0,0 is the top left of the map
	 */
	public void drawLineMap(int x1, int y1, int x2, int y2) {
		doCommand(StarCraftCommand.lineMap, x1, y1, x2, y2);
	}

	/**
	 * Draws a line on the screen. 0,0 is the top left of the screen
	 */
	public void drawLineScreen(int x1, int y1, int x2, int y2) {
		doCommand(StarCraftCommand.lineScreen, x1, y1, x2, y2);
	}

	/**
	 * Draws a circle on the map. 0,0 is the top left of the map
	 */
	public void drawCircleMap(int x, int y, int radius, boolean filled) {
		doCommand(StarCraftCommand.circleMap, x, y, radius, filled ? 1 : 0);
	}

	/**
	 * Draws a circle on the screen. 0,0 is the top left of the screen
	 */
	public void drawCircleScreen(int x, int y, int radius, boolean filled) {
		doCommand(StarCraftCommand.circleScreen, x, y, radius, filled ? 1 : 0);
	}
	 ...
	 */
	public void drawRectMap(int left, int top, int right, int bottom) {
		doCommand(StarCraftCommand.rectMap, left, top, right, bottom);
	}
	 ...
	 * Rectangles are not filled.
	 */
	public void drawRectScreen(int left, int top, int right, int bottom) {
		doCommand(StarCraftCommand.rectScreen, left, top, right, bottom);
	}
	...
	public void drawBoxMap(int left, int top, int right, int bottom) {
		doCommand(StarCraftCommand.boxMap, left, top, right, bottom);
	}
	...
	public void drawBoxScreen(int left, int top, int right, int bottom) {
		doCommand(StarCraftCommand.boxScreen, left, top, right, bottom);
	}
	...
	public void setColor(Color color) {
		...
		doCommand(StarCraftCommand.color, c, 0, 0, 0);
	}
	...
	public void setColor(int color) {
		doCommand(StarCraftCommand.color, color, 0, 0, 0);
	}

	public void leaveGame() {
		doCommand(StarCraftCommand.leaveGame, 0, 0, 0, 0);
	}

	public void sayHello() {
		doCommand(StarCraftCommand.sayHello, 0, 0, 0, 0);
	}

	public void sayGG() {
		doCommand(StarCraftCommand.sayGG, 0, 0, 0, 0);
	}
}
