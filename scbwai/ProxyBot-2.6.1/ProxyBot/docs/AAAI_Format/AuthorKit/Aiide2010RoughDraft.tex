...
Real-time strategy(RTS) games normally involve players commanding an army of units to build structures, collect resources and attack enemy players.%cont

\subsection{BWAPI}
%Rewrite
<BWAPI is an open-source Application Programming Interface (API) that enables AI creators [code injection] into Starcraft: Broodwar.>  It was developed in C++, but many extensions have allowed access to other languages such as Python, C\#, and Java.  For the purposes of KhasBot, Java has been used.
