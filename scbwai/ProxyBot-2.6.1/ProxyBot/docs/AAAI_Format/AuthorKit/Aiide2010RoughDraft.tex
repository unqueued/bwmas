...
We found that other researchers have approached this problem using other frameworks, some not explicitly agent based, to develop their AI.  The authors of \cite{TheCrapPaper}, used the BWSAL\footnote{\url{linkhere}} to implement a simple strategy with an agent minded outset.
